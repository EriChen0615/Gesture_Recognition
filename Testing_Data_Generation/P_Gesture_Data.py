"""
This file is to generate Testing data for task2 & 3 in PNet
...
if __name__ == '__main__':
    dstdir = "../Dataset/Testing/train_PNet_aug"
    OUTPUT = '../Dataset/Testing'
    ...
    # train data
    net = "PNet"
    #the file contains the names of all the gesture Testing data
    train_txt = os.path.join('../Dataset/Testing',"imglist_with_gesture.txt")
