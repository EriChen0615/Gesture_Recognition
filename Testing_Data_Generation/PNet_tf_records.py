"""
This file is used to generate tf_records for Testing of PNet
...
def _get_output_filename(output_dir, name, net):
    ...
    return '%s/test_PNet_gesture.tfrecord' % (output_dir)
...
def get_dataset(dir, net='PNet'):
    ...
    item = 'imglists/PNet/test_%s_gesture.txt' % net
...
if __name__ == '__main__':
    dir = '../Dataset/Testing/'
    net = 'PNet'
    output_directory = '../Dataset/Testing/imglists/PNet'
