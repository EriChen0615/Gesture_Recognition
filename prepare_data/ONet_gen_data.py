"""
This python file is to genereate hand detection data for ONet Training
--crop into 48*48 pics and classifies into pos, neg, part
...
def parse_args():
    parser = argparse.ArgumentParser(description='Generate training data for ONet',
    ...
    parser.add_argument('--save_dir', dest='save_dir', help='directory to save the training data', default='../Training_Data/ONet-48') # model file location
    ...
    with open(anno_file,'r') as f:
        ...
        for annotation in annotations: 
            ...
            while neg_num < 5:
                ...
                # size is a random number between 48 and min(width,height)
                ...
                #resize the cropped image to size 48*48
            ...
            # here we already have 10 neg examples
            ...
            for box in boxes:
                ...
                for i in range(5):
                    ...
                    #rexize cropped image to be 48 * 48
                    resized_im = cv2.resize(cropped_im, (48, 48), interpolation=cv2.INTER_LINEAR)
                ...
                while p_idx < n_idx and d_idx < n_idx:
